...
/* ---------- Color tokens (white with black accents) ---------- */
const ACCENT = "#000000";
const ACCENT_RGB = "0, 0, 0";
const BG = "#FFFFFF";
const CARD = "#F0F0F0";
const CREAM = "#000000";
...
const timelineData = [
  {
    ...
    description: "R.M.S Saloon on Hendala Road — a local hair salon serving Wattala with sharp cuts and a welcoming chair.",
    image: aboutImages[0],
    side: "right" as const,
  },
  {
    year: "SERVICE",
    title: (<><span style={{ color: ACCENT }}>BUDGET</span><br /><span style={{ color: ACCENT }}>FRIENDLY</span></>),
    description: "Quality haircuts and styling at prices that keep regulars coming back — no appointment needed.",
    image: aboutImages[1],
    side: "left" as const,
  },
  {
    year: "COMFORT",
    title: (<><span style={{ color: ACCENT }}>A/C &</span><br /><span style={{ color: ACCENT }}>PARKING</span></>),
    description: "Air-conditioned salon with parking available — comfortable visits whether it's your first time or your fiftieth.",
    image: aboutImages[2],
    side: "right" as const,
  },
  {
    year: "STYLE",
    title: (<><span style={{ color: ACCENT }}>HAIR &</span><br /><span style={{ color: ACCENT }}>BEARD</span></>),
    description: "From clean fades to beard work and hairstyling — every look tailored to what you want.",
    image: aboutImages[3],
    side: "left" as const,
  },
  {
    ...
    description: "Walk in any day — we're open until 10 PM. Call 076 646 4662 or find us on Google Maps.",
    image: aboutImages[4],
    side: "right" as const,
  },
];
...
const servicesData = [
  // Main Services
  { num: "01", name: "Haircut", duration: "30–45 min", note: "Budget friendly", image: serviceImages[0] },
  { num: "02", name: "Shaving", duration: "15–25 min", note: "Clean finish", image: serviceImages[1] },
  { num: "03", name: "Head Massage", duration: "20–30 min", note: "Relaxing", image: serviceImages[2] },
  { num: "04", name: "Kids Cut", duration: "25–30 min", note: "All ages", image: serviceImages[4] },
  
  // Additional Services
  { num: "05", name: "Hair Straightening", duration: "Varies", note: "Professional", image: serviceImages[3] },
  { num: "06", name: "Hair Colouring", duration: "Varies", note: "Trendy", image: serviceImages[5] },
  { num: "07", name: "Cleanup", duration: "20–30 min", note: "Fresh look", image: serviceImages[2] },
  { num: "08", name: "Facial", duration: "30–45 min", note: "Grooming", image: serviceImages[0] },
  { num: "09", name: "Reborn", duration: "Varies", note: "Premium", image: serviceImages[1] },
];
        ...
        {[...items, ...items].map((it, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent px-3 py-2 text-[10px] uppercase tracking-widest text-black/80">
                cut {it.number}
              </div>
            </div>
          );
  ...
  return (
    ...
    >
      ...
      {loading && (
        <div className="fixed inset-0 z-[130] flex flex-col items-center justify-center" style={{ background: BG }}>
          <BrandLogo textClassName="text-4xl" imgClassName="h-16 w-auto max-w-[280px] object-contain" />
          <p className="mt-8 text-xs tracking-[0.3em] text-black/60">{progress}%</p>
          <div className="mt-3 h-[2px] w-52 overflow-hidden rounded-full bg-black/10">
      ...
      <header
        ...
        style={{ background: scrolled ? "rgba(255,255,255,0.8)" : "transparent", backdropFilter: "blur(10px)" }}
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3 text-[11px] uppercase tracking-[0.24em] lg:px-10">
          <BrandLogo imgClassName="h-14 w-auto max-w-[240px] object-contain" />
          <nav className="hidden items-center gap-8 text-black/70 md:flex">
            <a href="#cuts" className="transition hover:text-black" style={{ color: CREAM }}>Gallery</a>
            <a href="#services" className="transition hover:text-black" style={{ color: CREAM }}>Services</a>
            <a href="#story" className="transition hover:text-black" style={{ color: CREAM }}>About</a>
            <a href="#reviews" className="transition hover:text-black" style={{ color: CREAM }}>Reviews</a>
            <a href="#location" className="transition hover:text-black" style={{ color: CREAM }}>Location</a>
          </nav>
          <a
        ...
        <section className="relative flex min-h-screen items-center">
          <div className="absolute inset-0">
            <SiteImage
              ...
              loading="eager"
            />
            <div className="absolute inset-0" style={{ background: `linear-gradient(90deg, rgba(255,255,255,0.7) 0%, rgba(255,255,255,0.6) 40%, rgba(255,255,255,0.7) 100%)` }} />
          </div>
          ...
          <motion.div
            ...
            className="pointer-events-none absolute right-6 top-28 hidden select-none font-black leading-none tracking-[0.08em] text-black/5 md:block lg:text-[9vw]"
          ...
          <div className="relative mx-auto grid w-full max-w-7xl items-center gap-10 px-5 pb-16 pt-36 md:grid-cols-2 lg:px-10">
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 1.2 }}
              className="overflow-hidden rounded-[2rem] border border-black/10 shadow-2xl"
            >
              <SiteImage
            ...
            <div className="text-center md:text-left">
              ...
              <motion.h1
                ...
                style={{ fontFamily: "Poppins, sans-serif", fontSize: "clamp(2.4rem, 9vw, 5.8rem)" }}
              >
              ...
              <motion.p
                ...
                className="mt-5 max-w-md text-sm leading-relaxed text-black/70"
              >
              ...
              >
                ...
                <a href="https://wa.me/94766464662?text=Hello%20I%27m%20interested%20in%20getting%20a%20cut" target="_blank" rel="noopener noreferrer">
    <button className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-2.5 text-xs font-semibold uppercase tracking-[0.22em] text-white transition hover:scale-105">
      ...
      <ArrowRight className="h-3.5 w-3.5" />
                ...
                <a href="#location" className="inline-flex items-center gap-2 rounded-full border border-black/50 px-5 py-2.5 text-[11px] uppercase tracking-[0.18em] text-black transition hover:border-black hover:text-black">
                  Get directions
                </a>
              </motion.div>
            </div>
        ...
        <section id="cuts" className="relative px-0 py-24">
          <div className="mx-auto mb-10 max-w-7xl px-5 lg:px-10">
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              ...
              <p className="max-w-sm text-xs leading-relaxed text-black/60">
                Real cuts from R.M.S Saloon — fades, trims, and styles our clients walk out wearing every day.
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto mt-10 flex max-w-7xl items-center justify-between px-5 lg:px-10">
            <p className="text-[10px] uppercase tracking-[0.26em] text-black/50">Scroll · hover · repeat</p>
        ...
        <section className="relative overflow-hidden px-5 py-24 lg:px-10">
          ...
          <div className="relative mx-auto max-w-6xl">
            <div className="flex flex-col items-start justify-between gap-3 md:flex-row md:items-end">
              ...
              <p className="max-w-[210px] text-[10px] leading-relaxed text-black/55 md:text-right">
                ...
                {[
                  ...
                  <div key={s.n} className="flex items-center gap-3 md:flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-black/55">{s.desc}</p>
                    </div>
                    {i < arr.length - 1 && (
            ...
            <div className="relative mt-8 min-h-[520px]">
              {workCollage.map((c, i) => (
                ...
                >
                  <SiteImage image={c} alt="work" className="h-full w-full object-cover" loading="lazy" />
                </motion.div>
              ))}
        ...
        <section id="story" ref={timelineRef} className="relative px-5 py-24 lg:px-10">
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-6 md:grid-cols-[1.1fr_0.9fr] md:items-end">
              ...
              <p className="self-end text-[11px] leading-relaxed text-black/60">
                Hendala Road, Wattala — serving the community with great hair and friendly service.
              </p>
            </div>
                      ...
                      {isRight ? (
                        <>
                          <div className="md:col-start-1 md:row-start-1 md:mt-28">
                            ...
                            <p className="mt-3 ml-auto max-w-sm text-sm text-black/70 md:text-right">{item.description}</p>
                          </div>
                          <div className="mt-4 md:col-start-2 md:row-start-1 md:mt-0">
                            <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.28em] text-black/75 md:text-right">{item.year}</p>
                        ...
                        <>
                          <div className="md:col-start-1 md:row-start-1">
                            <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.28em] text-black/75">{item.year}</p>
                            <div className="overflow-hidden rounded-3xl border border-white/10 shadow-lg">
                              <img alt={item.year} className="h-60 w-full object-cover" loading="eager" {...localImageAttrs(item.image)} />
                            </div>
                          </div>
                          <div className="mt-4 md:col-start-2 md:row-start-1 md:mt-28">
                            ...
                            <p className="mt-3 max-w-sm text-sm text-black/70">{item.description}</p>
                          </div>
                        </>
                      )}
                    </div>
    ...
    <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
      <div>
        ...
        <p className="mt-2 text-[11px] text-black/55">Walk-in welcome · Budget friendly · Open until 10 PM</p>
      </div>
    </div>
              ...
              {servicesData.map((s, i) => (
                ...
                >
                  ...
                  <div className="h-56 overflow-hidden">
                    <img alt={s.name} className="h-full w-full object-cover transition duration-500 group-hover:scale-110" loading="lazy" {...localImageAttrs(s.image)} />
                  </div>
                  <div className="p-5">
        ...
        <section className="relative px-5 py-24 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-6 text-lg leading-relaxed text-black/80">
              We undertake special grooming packages from Rs. 15,000/- on a reservation basis.
            </p>
            <div className="mt-8">
              <a href="https://wa.me/94766464662?text=Hello%20I%27m%20interested%20in%20the%20wedding%20grooming%20package" target="_blank" rel="noopener noreferrer">
                <AccentButton>
                  Reserve Now
                  <ArrowRight className="h-3.5 w-3.5" />
                </AccentButton>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="relative mt-12 flex items-center justify-center">
              <div className="hidden w-60 flex-shrink-0 scale-90 opacity-30 md:block">
                <div className="rounded-3xl border border-black/10 p-6" style={{ background: CARD }}>
                  <StarRating rating={prev.rating} />
                  <p className="mt-3 text-xs leading-relaxed text-black/70">&ldquo;{prev.quote}&rdquo;</p>
              ...
              <div className="hidden w-60 flex-shrink-0 scale-90 opacity-30 md:block">
                <div className="rounded-3xl border border-black/10 p-6" style={{ background: CARD }}>
                  ...
                  <p className="mt-3 text-xs leading-relaxed text-black/70">&ldquo;{next.quote}&rdquo;</p>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-2">
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all ${i === activeTestimonial ? "w-6" : "w-2 bg-black/25"}`}
                  style={i === activeTestimonial ? { background: ACCENT } : {}}
            ...
            <div className="mt-6 flex items-center justify-center gap-3">
              <button onClick={() => setActiveTestimonial((i) => (i - 1 + testimonials.length) % testimonials.length)}
                className="flex h-10 w-10 items-center justify-center rounded-full border border-black/20 transition hover:scale-110" style={{ borderColor: ACCENT, color: ACCENT }}>
                ←
              </button>
        ...
        <section id="location" className="relative px-5 py-24 lg:px-10">
          <div className="mx-auto max-w-6xl">
            <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
              ...
              <p className="max-w-sm text-[11px] leading-relaxed text-black/60">
                175 Hendala Rd, Wattala — walk in or call {siteConfig.location.phone}. Open daily until 10 PM.
              </p>
            </div>

            <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_1.2fr]">
              <div className="rounded-3xl border border-black/10 p-6 md:p-8" style={{ background: CARD }}>
                <div className="space-y-5">
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.28em] text-black/50">Address</p>
                    <p className="mt-2 flex items-start gap-2 text-sm text-black/85">
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.28em] text-black/50">Contact</p>
                    <ul className="mt-2 space-y-2 text-sm text-black/80">
                      <li className="flex items-center gap-2">
                        <PhoneIcon className="h-4 w-4" style={{ color: ACCENT }} />
                        <a href={`tel:${siteConfig.location.phoneTel}`} className="transition hover:text-black">{siteConfig.location.phone}</a>
                      </li>
                      <li className="flex items-center gap-2">
                        <WhatsAppIcon className="h-4 w-4" style={{ color: "#25D366" }} />
                        <a href="https://wa.me/94766464662?text=Hello%20I%27m%20interested%20in%20getting%20a%20cut" target="_blank" rel="noopener noreferrer" className="transition hover:text-[#25D366]">WhatsApp</a>
                      </li>
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.28em] text-black/50">Amenities</p>
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.28em] text-black/50">Hours</p>
                    <ul className="mt-2 space-y-1.5 text-sm text-black/75">
                      {siteConfig.location.hours.map((h) => (
                        <li key={h.days} className="flex justify-between gap-4">
                          <span>{h.days}</span>
                          <span className="text-black/55">{h.time}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
              ...
              {siteConfig.location.mapsEmbedUrl ? (
                <div className="overflow-hidden rounded-3xl border border-white/10" style={{ minHeight: "360px" }}>
                  <iframe
                    ...
                    className="h-full min-h-[360px] w-full border-0 grayscale-[30%] invert-[92%] contrast-[90%]"
                    loading="lazy"
                ...
                <div className="flex min-h-[360px] items-center justify-center rounded-3xl border border-dashed border-black/15 text-center text-sm text-black/45" style={{ background: CARD }}>
                  Add a map embed URL in <code className="mx-1 text-black/70">src/config/siteConfig.ts</code>
                </div>
              )}
            </div>
          </div>
        ...
        <section className="relative px-5 py-24 lg:px-10">
          ...
          <div className="mx-auto mt-10 max-w-2xl overflow-hidden rounded-3xl border border-black/10" style={{ background: CARD }}>
            {faqs.map((f, i) => {
              ...
              return (
                <div key={f.q} className="border-b border-black/10 last:border-b-0">
                  <button
                    ...
                    className="flex w-full items-center justify-between px-5 py-4 text-left text-[11px] uppercase tracking-[0.18em] transition hover:bg-black/5"
                  >
                  ...
                  >
                    <p className="px-5 pb-4 text-[11px] leading-relaxed text-black/65">{f.a}</p>
                  </motion.div>
                </div>
              );
            })}
      ...
      {/* FOOTER */}
      <footer className="mt-10" style={{ background: "#F0F0F0" }}>
        <div className="mx-auto grid max-w-7xl gap-8 px-5 py-14 md:grid-cols-4 lg:px-10">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-[11px] text-black/70">
              ...
              <li className="flex items-center gap-2"><MailIcon className="h-3.5 w-3.5" style={{ color: ACCENT }} />{siteConfig.location.email}</li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="mt-3 flex gap-3">
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full border border-black/15 transition hover:scale-110" style={{ borderColor: `${ACCENT}55`, color: ACCENT }}><InstagramIcon className="h-4 w-4" /></a>
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full border border-black/15 transition hover:scale-110" style={{ borderColor: `${ACCENT}55`, color: ACCENT }}><TikTokIcon className="h-4 w-4" /></a>
              <a href="https://web.facebook.com/p/Saloon-RMS-100093354053748/?_rdc=1&_rdr#" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full border border-black/15 transition hover:scale-110" style={{ borderColor: `${ACCENT}55`, color: ACCENT }}><FacebookIcon className="h-4 w-4" /></a>
              <a href="https://wa.me/94766464662?text=Hello%20I%27m%20interested%20in%20getting%20a%20cut" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full border border-[#25D366] transition hover:scale-110" style={{ color: "#25D366" }}><WhatsAppIcon className="h-4 w-4" /></a>
            </div>
          </div>
        </div>
        <div className="px-5 py-4 text-center text-[10px] uppercase tracking-[0.22em] text-black/40 lg:px-10">
